...
public class NodeControl {
    ...
    public static UploadViewPort getUploadJson(boolean IsVisible, List<String> guids) {
        ControlTree DCTTreeRoot = ModelControl.getModelControl().getDCTTreeRoot();
        ...
        ControlTree FloorsTreeRoot = ModelControl.getModelControl().getFloorsTreeRoot();
...
//                                    Log.e("NodeControl", "system:" + systemNowNode.getM_name() + "|" + "cate:" + cate.getM_name() + "|" + "type:" + Nowtype.getM_name() +"|"+ String.valueOf(true));
//                                    Nowtype.setVisiable(true, true);
//                                }
                                ModelView.modelSHCategory(cate.getM_name(), systemNowNode.getM_name(), true, false);
                                Log.e("NodeControl", "system:" + systemNowNode.getM_name() + "|" + "cate:" + cate.getM_name() + "|" + String.valueOf(true));
                                ...
                                for (ControlTree NowType : EntityTypes) {
                                    ...
                                    if (typecount == typeVNodeList.size()) {
                                        ...
                                        Log.e("NodeControl", "system:" + systemNowNode.getM_name() + "|" + "cate:" + cate.getM_name() + "|" + "type:" + NowType.getM_name() + "|" + String.valueOf(false));
                        ...
                        if (catecount == cateVNodeList.size()) {
                            ...
                            Log.e("NodeControl", "system:" + systemNowNode.getM_name() + "|" + "cate:" + cate.getM_name() + "|" + String.valueOf(false));
                ...
                if (systemcount == systemList.size()) {
                    ...
                    Log.e("NodeControl", "system:" + systemNowNode.getM_name() + "|" + String.valueOf(false));
...
//                        ModelView.hiddenEntity(guids.get(o));
                        ModelControl.getModelControl().ctrlHideList(guids.get(o), true);
                    }
                } else {
                    ModelControl.getModelControl().ctrlOnlyShowList(guids);
                }
            }
    ...
    public static void reductionToView() {
        //先获得视口对象
        List<ControlTree> nodeSystemList = ModelControl.getModelControl().getDCTTreeRoot().getM_children();
