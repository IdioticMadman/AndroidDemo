package com.example.spindemo.view;
...
public class NiceSpinner extends TextView {
    private static final String TAG = "NiceSpinner";
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        popWindowHeight = typedArray.getDimension(R.styleable.NiceSpinner_pop_window_max_height, 0);
    ...
    private int getListViewHeight() {
        ...
        if (adapter == null) {
            ...
            if (count > 0) {
                ...
                Log.e(TAG, "getListViewHeight: " + childViewHeight * count);
                return childViewHeight * count;
            } else {
                return 0;
            }
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e(TAG, "onMeasure: " + dip2px(popWindowHeight));
        if (getListViewHeight() < dip2px(popWindowHeight)) {
            popupWindow.setHeight(WindowManager.LayoutParams.WRAP_CONTENT);
        } else {
            popupWindow.setHeight(dip2px(popWindowHeight));
        }
