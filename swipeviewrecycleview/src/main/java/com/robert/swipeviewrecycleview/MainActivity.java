package com.robert.swipeviewrecycleview;
...
import com.robert.swipeviewrecycleview.view.DividerItemDecoration;
import com.robert.swipeviewrecycleview.view.SwapRecyclerView;
import com.robert.swipeviewrecycleview.view.SwipeMenuBuilder;
import com.robert.swipeviewrecycleview.view.SwipeMenuView;
...
//                Toast.makeText(MainActivity.this, "onSwipeEnd-" + position, Toast.LENGTH_SHORT).show();
    ...
    private SwipeMenuView.OnMenuItemClickListener mOnSwipeItemClickListener = new SwipeMenuView.OnMenuItemClickListener() {
        ...
        public void onMenuItemClick(int pos, SwipeMenu menu, int index) {
            Toast.makeText(MainActivity.this, menu.getItem(index).getTitle(), Toast.LENGTH_LONG).show();
            if (index == 1) {
                recyclerView.smoothCloseMenu(pos);
                list.remove(pos);
                adapter.remove(pos);
