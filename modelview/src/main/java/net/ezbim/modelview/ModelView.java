...
public class ModelView {
    ...
    public static native void initAxisGridFontPath(String path);

    public static native void loadAxisGrid();

    public static native void unLoadAxisGrid();

    public static native void hideAxisGrid();

    public static native void unHideAxisGrid();

    public static native void setAxisGridHeightByFloorName(String floorName);
...
//    public static native void keyboardUp(int key);
    ...
    public static native void highlightWithOpacity(String entityID, float opacity, boolean transparent);//高亮指定ID的构件或者组
...
//    public static native void exitModelView();//退出ModelView，清理ModelView在JNI的引用。如果需要重新调用，需要重新initModelView
    ...
    public static native void transParentAllWithOpacity(float opacity);//设置全部透明状态
